                            ...
                            <tbody>
                                @foreach ($all_enseignants as $enseignant)
                                    <tr class="odd gradeX">
                                        ...
                                        <td>
                                            {{ number_format($enseignant->salaire,0,'.',' ').' GNF' }}
                                        </td>
                                        <td>
                    ...
                    <div class="col-md-12">
                                ...
                                <tbody id="bordure_table">
                                    @foreach ($all_enseignants as $enseignant)
                                        <tr id="bordure_table">
                                            ...
                                            <td class="text-center" id="bordure_table">{{ number_format($enseignant->salaire,0,'.',' ').' GNF' }}</td>
                                        </tr>
                                    @endforeach
                                </tbody>
                            </table>
                        ...
                        <div class="">
                            <h4 class=" pull-right font-bold addr-font-h4">
                              Labé, le {{ date('d/m/Y') }}<br><br>La Direction
                            </h4>
                        </div>
                    </div>
                </div>
