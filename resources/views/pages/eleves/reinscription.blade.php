...
<div class="page-bar">
    <div class="page-title-breadcrumb">
        <div class=" pull-left">
            <div class="page-title">Réinscriptions Des </div>
        </div>
        <ol class="breadcrumb page-breadcrumb pull-right">
            ...
            <li class="active">Réinscriptions Des Etudiants</li>
        </ol>
    </div>
</div>
<div class="row">
    <div class="col-md-12">
        <div class="card card-topline-red">
            <div class="card-head">
                <header>Réinscriptions Des Etudiants de la {{ $niveau_choisit->nom_niveau.' '.$niveau_choisit->options }}</header>
                <div class="tools">
                    ...
                    <div class="col-md-12 col-sm-12 col-12">
                        <div class="btn-group">
                            ...
                            <a href="{{ route('listes_eleves_reinscrits') }}" id="addRow"
                                ...
                                <i class="fa fa-list"></i> Liste Des Etudiants Réinscrits
                            </a>
                        </div>
