...
class PaiementPersonnelController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $paiement_du_personnel = PaiementPersonnel::create([
                                                              ...
                                                              'salaire_du_mois' => $request->salaire_du_mois,
        ...
        return redirect()->route('paiement_personnel.show',$request->personnel_id);
    }
    ...
    public function show($id)
    {
        ...
        $all_paiement = PaiementPersonnel::where('personnel_id',$id)
                                          ->orderBy('date_paiement','desc')
                                          ->get();

        $personnel = Personnel::where('id',$id)->first();
        return view('pages.paiement_personnel/show',compact('chemin_theme_actif','nom','avatar','annee_courante','all_annee','personnel','all_paiement'));
    ...
    public function paiement_personnel_par_mois($id)
    {
        //
       /**
         * on appelle la methode InfosUser_AND_ThemeActive qui contient
        ...
        return view('pages.paiement_personnel/index',compact('chemin_theme_actif','nom','avatar','annee_courante','all_annee','all_personnels','num_mois'));
