     ...
     */
     ...
     public function reinscription()
     {
        if(auth()->user()->hasPermissionTo('Réinscription D\'un Elève'))
        {
            ...
            $anciens_eleves = Inscrit::where('annee_id',$id_annee_passer)->where('niveau_id',1)->with('eleve','niveau')->get();
            ...
            return view('pages.eleves.reinscription',compact('chemin_theme_actif','nom','avatar','all_niveaux','annee_courante','all_annee','anciens_eleves','niveau_choisit'));
        }
        else
        {
            return view('errors.403');
