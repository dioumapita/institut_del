...
class Niveau extends Model
{
     ...
     * @var array
     */
    protected $fillable = ['nom_niveau', 'options', 'moyennee_admission', 'scolarite','mensualite','tranche1', 'tranche2','tranche3','frais_inscription','frais_reinscription','status','created_at', 'updated_at'];
