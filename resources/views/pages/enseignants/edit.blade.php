                                    ...
                                    <div class="col-lg-12 p-t-20">
                                        <!-- Start salaire de l'enseignant -->
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-5">
                                                    <div class="input-group">
                                                        <input type="text" name="salaire" id="salaire" placeholder="Veuillez saisir le salaire de l'enseignant"
                                                            class="form-control @error('salaire')is-invalid @enderror" value="{{ old('salaire')?old('salaire'):$infos_enseignant->salaire }}" required />
                                                            @error('salaire')
                                                                <span class="invalid-feedback" role="alert">
                                                                    <strong id="msg_error_profil">{{ $message }}</strong>
                                                                </span>
