                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-5">
                                                <select name="status" class="form-control @error('status')is-invalid @enderror" required>
                                                    ...
                                                    <option value="PRIMAIRE"@if( $niveau->status =="PRIMAIRE") selected="selected" @endif>PRIMAIRE</option>
                                                    <option value="SECONDAIRE" @if( $niveau->status == "SECONDAIRE") selected="selected" @endif>SECONDAIRE</option>
                                                </select>
                                                @error('options')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong id="msg_error_profil">{{ $message }}</strong>
