...
Route::get('/paiement_personnel_par_mois/{id}','PaiementPersonnelController@paiement_personnel_par_mois')->name('paiement_des_personnels_par_mois')->middleware(['auth','licence.key','permission:Gestion Du Personnel']);
