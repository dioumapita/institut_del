...
@section('content')
    ...
    @if($all_paiement->count() > 0)
        <a href="{{ route('paiement_des_enseignants_par_mois',$all_paiement->last()->mois_paiement) }}" class="btn btn-info"><i class="fa fa-reply"></i> Retour</a>
    @else
                        ...
                        <div class="col-md-12">
                            ...
                            <div id="cadres">
                                ...
                                <table class="table table-bordered">
                                    <thead>
                                        <th id="bordure_table">Enseignant</th>
                                    ...
                                    <tbody>
                                        <tr id="bordure_table">
                                            <td id="bordure_table">{{ $enseignant->prenom.' '.$enseignant->nom }}</td>
                                            <td id="bordure_table">{{ $enseignant->telephone }}</td>
                                            <td id="bordure_table">
                                                @if ($enseignant->PaiementEnseignants->last()->mois_paiement == 1)
                                                    {{ "Janvier" }}
                                                @elseif($enseignant->PaiementEnseignants->last()->mois_paiement == 2)
                                                    {{ "Février" }}
                                                @elseif($enseignant->PaiementEnseignants->last()->mois_paiement == 3)
                                                    {{ "Mars" }}
                                                @elseif($enseignant->PaiementEnseignants->last()->mois_paiement == 4)
                                                    {{ "Avril" }}
                                                @elseif($enseignant->PaiementEnseignants->last()->mois_paiement == 5)
                                                    {{ "Mai" }}
                                                @elseif($enseignant->PaiementEnseignants->last()->mois_paiement == 6)
                                                    {{ "Juin"}}
                                                @elseif($enseignant->PaiementEnseignants->last()->mois_paiement == 7)
                                                    {{ "Juillet" }}
                                                @elseif($enseignant->PaiementEnseignants->last()->mois_paiement == 8)
                                                    {{ "Août" }}
                                                @elseif($enseignant->PaiementEnseignants->last()->mois_paiement == 9)
                                                    {{ "Septembre" }}
                                                @elseif($enseignant->PaiementEnseignants->last()->mois_paiement == 10)
                                                    {{ "Octobre" }}
                                                @elseif($enseignant->PaiementEnseignants->last()->mois_paiement == 11)
                                                    {{ "Novembre" }}
                                                @else
                                                    {{ "Décembre" }}
                                                @endif
                                            </td>
                                            <td id="bordure_table">{{ number_format($enseignant->PaiementEnseignants->last()->salaire_du_mois,0,'.',' ') }}</td>
                                            <td id="bordure_table">{{ number_format($enseignant->PaiementEnseignants->last()->somme_payer,0,'.',' ') }}</td>
                                            <td id="bordure_table">
                                                {{ number_format($enseignant->PaiementEnseignants->last()->salaire_du_mois - $enseignant->PaiementEnseignants->last()->somme_payer,0,'.',' ') }}
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="col-md-6 pull-left">
                                            <h4 class="font-bold text-left">Enseignant</h4>
                                        </div>
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        <tr id="bordure_table">
                                            ...
                                            <td id="bordure_table">{{ number_format($enseignant->PaiementEnseignants->last()->salaire_du_mois,0,'.',' ') }}</td>
                                            <td id="bordure_table">{{ number_format($enseignant->PaiementEnseignants->last()->somme_payer,0,'.',' ') }}</td>
                                            <td id="bordure_table">{{ number_format($enseignant->PaiementEnseignants->last()->salaire_du_mois - $enseignant->PaiementEnseignants->last()->somme_payer,0,'.',' ') }}</td>
                                        </tr>
                                    </tbody>
                                </table>
                                {{-- <p>Recevez, cher parent/tuteur, nos sincères salutations</p> --}}
